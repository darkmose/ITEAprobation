...
public partial class GameEntity {
    ...
    public void AddFollow(UnityEngine.GameObject newFolowTarget) {
        var index = GameComponentsLookup.Follow;
        var component = (FollowComponent)CreateComponent(index, typeof(FollowComponent));
        component.FolowTarget = newFolowTarget;
        AddComponent(index, component);
    }

    public void ReplaceFollow(UnityEngine.GameObject newFolowTarget) {
        var index = GameComponentsLookup.Follow;
        var component = (FollowComponent)CreateComponent(index, typeof(FollowComponent));
        component.FolowTarget = newFolowTarget;
